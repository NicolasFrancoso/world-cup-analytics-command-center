...
Team dimension table containing all teams that played FIFA World Cup matches.
...
| Column              | Type    | Description                                                 |
| ------------------- | ------- | ----------------------------------------------------------- |
| team_id             | integer | Surrogate key created for each team                                              |
| team                | string  | Team name                        |
